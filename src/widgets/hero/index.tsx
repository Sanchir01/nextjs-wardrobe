...
const HeroBlock = () => {
	...
	return (
		<section
			ref={observeRef}
			id='hero'
			className="relative min-h-dvh bg-[url('/img/heroBg.png')] bg-no-repeat bg-center bg-cover text-white uppercase pt-20 max-[768px]:pt-14"
		>
			{/* Затемняющий слой */}
            ...
            max-[768px]:gap-[5px] max-[768px]:flex-col max-[576px]:items-start max-[576px]:font-normal max-[576px]:normal-case max-[576px]:mt-3'
					...
					<Button classname='w-full text-lg py-[10px] min-[769px]:hidden uppercase mt-auto pb-3 max-[769px]:text-sm bg-custom-black text-w mb-10'>
