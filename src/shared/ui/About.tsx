		...
		>
			<div className='container'>
				...
				<div className='grid grid-cols-6 max-[998px]:hidden '>
					<Title
						text='Гардербные системы хранения и двери-купе помогут навести  порядок и создать стильное пространство'
						size='lg'
				...
				<div className='grid grid-cols-6 mt-5 font-normal max-[998px]:grid-cols-4 max-[998px]:place-items-center '>
					<div className='col-start-3 col-end-6 flex gap-[30px] max-[998px]:col-start-1 '>
						<p className='max-w-[383px]  '>
							Гардеробные системы хранения и двери-купе — это идеальное решение
							для тех, кто ценит порядок и стиль. Забудьте о беспорядке и
							бесконечных поисках нужных вещей. С нашими системами хранения вы
							сможете максимально эффективно использовать пространство.
						</p>
